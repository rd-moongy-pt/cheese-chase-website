...
function omitReactElements(props) {
  return Object.fromEntries(
    Object.entries(props).filter(([key, value]) => {
      return value !== void 0 && key !== "children" && !(0, import_react36.isValidElement)(value);
    })
  );
}
...
function useImage(props) {
  ...
  const imageRef = (0, import_react47.useRef)(null);
...
function useCheckbox(props = {}) {
  ...
  const isFocusVisibleRef = (0, import_react60.useRef)(false);
...
var InFocusGuard = function InFocusGuard2(_ref2) {
  ...
  return import_react68.default.createElement(import_react68.Fragment, null, import_react68.default.createElement("div", {
    key: "guard-first",
    "data-focus-guard": true,
    "data-focus-auto-guard": true,
    style: hiddenGuard
  }), children, children && import_react68.default.createElement("div", {
    key: "guard-last",
    "data-focus-guard": true,
    "data-focus-auto-guard": true,
    style: hiddenGuard
...
var focusScope = (0, import_react71.createContext)(void 0);

// node_modules/react-focus-lock/dist/es2015/Lock.js
var emptyArray = [];
var FocusLock = (0, import_react72.forwardRef)(function FocusLockUI(props, parentRef) {
  var _extends2;
  var _useState = (0, import_react72.useState)(), realObserved = _useState[0], setObserved = _useState[1];
  var observed = (0, import_react72.useRef)();
  var isActive = (0, import_react72.useRef)(false);
  var originalFocusedElement = (0, import_react72.useRef)(null);
  var _useState2 = (0, import_react72.useState)({}), update = _useState2[1];
  ...
  var _useState3 = (0, import_react72.useState)({}), id = _useState3[0];
  var onActivation = (0, import_react72.useCallback)(function(_ref2) {
  ...
  var onDeactivation = (0, import_react72.useCallback)(function() {
  ...
  var returnFocus = (0, import_react72.useCallback)(function(allowDefer) {
  ...
  var onFocus3 = (0, import_react72.useCallback)(function(event) {
    if (isActive.current) {
      mediumFocus.useMedium(event);
    }
  }, []);
  var onBlur3 = mediumBlur.useMedium;
  var setObserveNode = (0, import_react72.useCallback)(function(newObserved) {
  ...
  var focusScopeValue = (0, import_react72.useMemo)(function() {
    return {
      observed,
      shards,
      enabled: !disabled,
  ...
  return import_react72.default.createElement(import_react72.Fragment, null, hasLeadingGuards && [
    ...
    hasPositiveIndices ? import_react72.default.createElement("div", {
      key: "guard-nearest",
      "data-focus-guard": true,
      tabIndex: disabled ? -1 : 1,
      style: hiddenGuard
    }) : null
  ], !disabled && import_react72.default.createElement(SideCar2, {
    id,
    ...
    focusOptions,
    noFocusGuards
  }), import_react72.default.createElement(Container3, _extends({
    ref: mergedRef
  }, lockProps, {
    className,
    onBlur: onBlur3,
    onFocus: onFocus3
  }), import_react72.default.createElement(focusScope.Provider, {
    value: focusScopeValue
  }, children)), hasTailingGuards && import_react72.default.createElement("div", {
    "data-focus-guard": true,
    tabIndex: disabled ? -1 : 0,
    style: hiddenGuard
  }));
...
// node_modules/react-focus-lock/dist/es2015/Combination.js
var FocusLockCombination = (0, import_react75.forwardRef)(function FocusLockUICombination(props, ref) {
  return import_react75.default.createElement(Lock_default, _extends({
...
var AutoFocusInside = function AutoFocusInside2(_ref2) {
  ...
  return import_react76.default.createElement("div", _extends({}, inlineProp(FOCUS_AUTO, !disabled), {
    className
  }), children);
};
...
function MoveFocusInside(_ref2) {
  ...
  var ref = (0, import_react77.useRef)(null);
  useFocusInside(isDisabled ? void 0 : ref);
  return import_react77.default.createElement("div", _extends({}, inlineProp(FOCUS_AUTO, !isDisabled), {
    ref,
    className
  }), children);
}
...
var FreeFocusInside = function FreeFocusInside2(_ref2) {
  ...
  return import_react78.default.createElement("div", _extends({}, inlineProp(FOCUS_ALLOW, true), {
    className
  }), children);
};
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime71.jsx)(import_jsx_runtime71.Fragment, { children: chunks.map((chunk, index) => {
    return chunk.match ? (0, import_jsx_runtime71.jsx)(Mark, { sx: styles2, children: chunk.text }, index) : (0, import_jsx_runtime71.jsx)(import_react83.Fragment, { children: chunk.text }, index);
  }) });
}
...
function createIcon(options) {
  ...
  const path = import_react84.Children.toArray(options.path);
...
var Indicator = forwardRef2(
  function Indicator2(props, ref) {
    ...
    const styles2 = (0, import_react85.useMemo)(
      () => ({
        display: "inline-flex",
        justifyContent: "center",
        alignItems: "center",
...
function useMediaQuery(query, options = {}) {
  ...
  const [value, setValue] = (0, import_react87.useState)(() => {
...
function useShortcut(props = {}) {
  ...
  const timeoutRef = (0, import_react88.useRef)(void 0);
  const flush = () => {
...
function useMenu(props = {}) {
  ...
  const scrollIntoViewRef = (0, import_react92.useRef)(true);
...
var SlideFade = (0, import_react99.forwardRef)(
...
var ScaleFade = (0, import_react100.forwardRef)(
...
var Fade = (0, import_react104.forwardRef)(
...
var Slide = (0, import_react105.forwardRef)(
...
function useSpinner(increment, decrement) {
  const [isSpinning, setIsSpinning] = (0, import_react107.useState)(false);
  const [action, setAction] = (0, import_react107.useState)(null);
  const [runOnce, setRunOnce] = (0, import_react107.useState)(true);
  const timeoutRef = (0, import_react107.useRef)(null);
  ...
  const up = (0, import_react107.useCallback)(() => {
    if (runOnce) {
      increment();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const down = (0, import_react107.useCallback)(() => {
    if (runOnce) {
      decrement();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const stop = (0, import_react107.useCallback)(() => {
    setRunOnce(true);
    setIsSpinning(false);
    removeTimeout();
  }, []);
...
function useNumberInput(props = {}) {
  ...
  const inputSelectionRef = (0, import_react108.useRef)(null);
  const incrementButtonRef = (0, import_react108.useRef)(null);
  const decrementButtonRef = (0, import_react108.useRef)(null);
  const sanitize = (0, import_react108.useCallback)(
    (value) => value.split("").filter(isValidCharacter).join(""),
    [isValidCharacter]
  );
  const parse3 = (0, import_react108.useCallback)(
    (value) => (parseValue == null ? void 0 : parseValue(value)) ?? value,
    [parseValue]
  );
  const format = (0, import_react108.useCallback)(
  ...
  const _onFocus = (0, import_react108.useCallback)(
    (event) => {
      var _a8;
  ...
  const ariaValueText = (0, import_react108.useMemo)(() => {
  ...
  const validateAndClamp = (0, import_react108.useCallback)(() => {
  ...
  const onInputBlur = (0, import_react108.useCallback)(() => {
    setFocused(false);
    if (clampValueOnBlur) {
      validateAndClamp();
    }
  }, [clampValueOnBlur, setFocused, validateAndClamp]);
  const focusInput = (0, import_react108.useCallback)(() => {
  ...
  const spinUp = (0, import_react108.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.up();
      focusInput();
  ...
  const spinDown = (0, import_react108.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.down();
      focusInput();
  ...
  const getIncrementButtonProps = (0, import_react108.useCallback)(
    (props2 = {}, ref = null) => {
  ...
  const getDecrementButtonProps = (0, import_react108.useCallback)(
    (props2 = {}, ref = null) => {
...
var NumberInput = forwardRef2(
  function NumberInput2(props, ref) {
    ...
    const ctx = (0, import_react109.useMemo)(() => context, [context]);
...
function usePinInput(props = {}) {
  ...
  const [moveFocus2, setMoveFocus] = (0, import_react110.useState)(true);
  ...
  const focusNext = (0, import_react110.useCallback)(
    (index) => {
  ...
  const setValue = (0, import_react110.useCallback)(
  ...
  const clear = (0, import_react110.useCallback)(() => {
    var _a8;
  ...
  const getNextValue = (0, import_react110.useCallback)((value2, eventValue) => {
...
function PinInput(props) {
  ...
  const clones = getValidChildren(children).map(
    (child) => (0, import_react111.cloneElement)(child, { __css: styles2 })
  );
...
function usePopover(props = {}) {
  ...
  const [restoreFocus, setRestoreFocus] = (0, import_react112.useState)(returnFocusOnClose);
  (0, import_react112.useEffect)(() => setRestoreFocus(returnFocusOnClose), [returnFocusOnClose]);
  ...
  const openTimeout = (0, import_react112.useRef)(void 0);
  const closeTimeout = (0, import_react112.useRef)(void 0);
...
function getElementRef(el) {
  var _a8;
  const version2 = React18.version;
...
function PopoverAnchor(props) {
  ...
  return (0, import_jsx_runtime118.jsx)(import_jsx_runtime118.Fragment, { children: (0, import_react113.cloneElement)(child, getAnchorProps(child.props, getElementRef(child))) });
}
...
function PopoverTrigger(props) {
  ...
  return (0, import_jsx_runtime126.jsx)(import_jsx_runtime126.Fragment, { children: (0, import_react114.cloneElement)(child, getTriggerProps(child.props, getElementRef(child))) });
}
...
function useRadioGroup(props = {}) {
  ...
  const [valueState, setValue] = (0, import_react116.useState)(defaultValue || "");
  const isControlled = typeof valueProp !== "undefined";
  const value = isControlled ? valueProp : valueState;
  const ref = (0, import_react116.useRef)(null);
  const focus = (0, import_react116.useCallback)(() => {
  ...
  const onChange = (0, import_react116.useCallback)(
    (eventOrValue) => {
...
var RadioGroup = forwardRef2((props, ref) => {
  ...
  const group = (0, import_react117.useMemo)(
    () => ({
      name,
      size: size2,
      onChange,
...
function useRadio(props = {}) {
  ...
  const uuid = `radio-${(0, import_react118.useId)()}`;
  ...
  const [isHovered, setHovering] = (0, import_react118.useState)(false);
  const [isActive, setActive] = (0, import_react118.useState)(false);
  const [isCheckedState, setChecked] = (0, import_react118.useState)(Boolean(defaultChecked));
  const isControlled = typeof isCheckedProp !== "undefined";
  const isChecked = isControlled ? isCheckedProp : isCheckedState;
  const isFocusVisibleRef = (0, import_react118.useRef)(false);
  (0, import_react118.useEffect)(() => {
    return trackFocusVisible((state22) => {
      isFocusVisibleRef.current = state22;
    });
  }, []);
  const handleChange = (0, import_react118.useCallback)(
    (event) => {
      if (isReadOnly || isDisabled) {
        event.preventDefault();
        return;
  ...
  const onKeyUp = (0, import_react118.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
...
var SelectIcon = (props) => {
  ...
  const clone = (0, import_react119.cloneElement)(children, {
    role: "presentation",
  ...
  return (0, import_jsx_runtime135.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react119.isValidElement)(children) ? clone : null });
};
...
function useIsFirstRender() {
  const isFirstRender = (0, import_react120.useRef)(true);
...
var Stack = forwardRef2((props, ref) => {
  ...
  const clones = (0, import_react125.useMemo)(() => {
    ...
    return shouldUseChildren ? validChildren : validChildren.map((child, index) => {
      ...
      return (0, import_jsx_runtime143.jsxs)(import_react125.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
function useTabs(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react129.useState)(defaultIndex ?? 0);
...
function useTooltip(props = {}) {
  ...
  const enterTimeout = (0, import_react132.useRef)(void 0);
  const clearEnterTimeout = (0, import_react132.useCallback)(() => {
    if (enterTimeout.current) {
      clearTimeout(enterTimeout.current);
      enterTimeout.current = void 0;
    }
  }, []);
  const exitTimeout = (0, import_react132.useRef)(void 0);
  const clearExitTimeout = (0, import_react132.useCallback)(() => {
    if (exitTimeout.current) {
      clearTimeout(exitTimeout.current);
      exitTimeout.current = void 0;
    }
  }, []);
  const closeNow = (0, import_react132.useCallback)(() => {
    clearExitTimeout();
    onClose();
  }, [onClose, clearExitTimeout]);
  const dispatchCloseEvent = useCloseEvent(ref, closeNow);
  const openWithDelay = (0, import_react132.useCallback)(() => {
  ...
  const closeWithDelay = (0, import_react132.useCallback)(() => {
    clearEnterTimeout();
    const win = getWin(ref);
  ...
  const onPointerDown = (0, import_react132.useCallback)(() => {
  ...
  const getTriggerProps = (0, import_react132.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const triggerProps = {
        ...props2,
  ...
  const getTooltipPositionerProps = (0, import_react132.useCallback)(
    (props2 = {}, forwardedRef = null) => getPopperProps(
      {
        ...props2,
        style: {
  ...
  const getTooltipProps = (0, import_react132.useCallback)(
    (props2 = {}, ref2 = null) => {
      const styles2 = {
        ...props2.style,
        position: "relative",
...
var Tooltip = forwardRef2((props, ref) => {
  ...
  const shouldWrap = !(0, import_react133.isValidElement)(children) || shouldWrapChildren;
  let trigger2;
  if (shouldWrap) {
    ...
    trigger2 = (0, import_react133.cloneElement)(
      child,
...
var Wrap = forwardRef2(function Wrap2(props, ref) {
  ...
  const _children = (0, import_react134.useMemo)(
    () => shouldWrapChildren ? import_react134.Children.map(children, (child, index) => (0, import_jsx_runtime185.jsx)(WrapItem, { children: child }, index)) : children,
