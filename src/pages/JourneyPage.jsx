      ...
      <Container maxW="container.xl" py={12}>
        ...
        >
          ...
          >
            <AspectRatio ratio={21/9}>
              <Image
                src={`${import.meta.env.BASE_URL}pictures/journey/grad.jpg`}
                alt="Lisbon Streets"
                objectFit="cover"
              />
            </AspectRatio>
        ...
        <VStack spacing={0} align="stretch">
          <TimelineItem
            ...
            isLeft={true}
            image={`${import.meta.env.BASE_URL}pictures/journey/letalo.jpg`}
          />
          ...
          <TimelineItem
            ...
            isLeft={false}
            image={`${import.meta.env.BASE_URL}pictures/journey/team-photo.jpg`}
          />
          ...
          <TimelineItem
            ...
            isLeft={true}
            image={`${import.meta.env.BASE_URL}/pictures/journey/krmp.jpg`}
          />
          ...
          <TimelineItem
            ...
            isLeft={false}
            image={`${import.meta.env.BASE_URL}/pictures/journey/41.jpg`}
          />
          ...
          <TimelineItem
            ...
            isLeft={true}
            image={`${import.meta.env.BASE_URL}/pictures/journey/IMG_3921.jpg`}
          />
          ...
          <TimelineItem
            ...
            isLeft={false}
            image={`${import.meta.env.BASE_URL}/pictures/journey/44.jpg`}
          />
        </VStack>
        ...
        >
          ...
          <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} spacing={8}>
            {[
              { src: `${import.meta.env.BASE_URL}pictures/journey/trip.jpg`, alt: "Weekend Trip" },
              { src: `${import.meta.env.BASE_URL}pictures/journey/66.jpg`, alt: "Cultural Visit" },
              { src: `${import.meta.env.BASE_URL}pictures/journey/52.jpg`, alt: "Team Dinner" }
            ].map((img, index) => (
              <MotionBox
                key={index}
